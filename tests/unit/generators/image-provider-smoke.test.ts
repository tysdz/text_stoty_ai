...
describe('image provider smoke tests', () => {
  ...
  it('Google Gemini localized text -> back data URL', async () => {
  ...
  it('Seedream localized text -> back ARK localized text URL', async () => {
    getProviderConfigMock.mockResolvedValueOnce({
      id: 'ark',
      apiKey: 'ark-key',
    })
  ...
  it('Seedream localized text -> localized text imageUrl localized text imageUrls', async () => {
    getProviderConfigMock.mockResolvedValueOnce({
      id: 'ark',
      apiKey: 'ark-key',
    })
  ...
  it('Gemini localized text -> localized text Gemini SDK localized text', async () => {
    getProviderConfigMock.mockResolvedValueOnce({
  ...
  it('Gemini localized text -> localized text inlineData', async () => {
    getProviderConfigMock.mockResolvedValueOnce({
      id: 'gemini-compatible:gm-1',
      apiKey: 'gm-key',
      baseUrl: 'https://gm.test',
