...
describe('worker video processor behavior', () => {
  ...
  it('VIDEO_PANEL: missing payload.videoModel localized text', async () => {
  ...
  it('VIDEO_PANEL: localized text COS upload', async () => {
    const processor = workerState.processor
    expect(processor).toBeTruthy()
  ...
  it('LIP_SYNC: missing panel localized text', async () => {
    const processor = workerState.processor
    expect(processor).toBeTruthy()
  ...
  it('LIP_SYNC: normal path writes back lipSyncVideoUrl and clears lipSyncTaskId', async () => {
    const processor = workerState.processor
    expect(processor).toBeTruthy()
