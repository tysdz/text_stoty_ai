...
vi.mock('@/lib/task/resolve-locale', () => ({
  resolveRequiredTaskLocale: vi.fn(() => 'vi'),
}))
...
const DIRECT_CASES: ReadonlyArray<DirectRouteCase> = [
  ...
  },
  {
    ...
    body: { voicePrompt: 'female calm narrator', previewText: 'localized text' },
  ...
  },
  {
    ...
    expectedPayloadSubset: {
      ...
      userInput: 'Automatically analyze surrounding shots and insert a naturally connected new panel。',
    },
  },
  {
