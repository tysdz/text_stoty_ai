...
interface NavItemData {
    ...
    label: string
    status: StepStatus
    href?: string  // localized text
    disabled?: boolean  // localized text（localized text）
    disabledLabel?: string  // localized text
}
...
interface CapsuleNavProps {
    ...
    episodeId?: string  // localized text
}

/**
 * NavItem - localized text
 * localized text、localized text/Ctrl+localized text
 */
function NavItem({
    active,
    onClick,
...
/**
 * CapsuleNav - localized text
 * localized textCtrl+localized text
 */
...
/**
 * EpisodeSelector - localized text
 */
interface Episode {
    id: string
    title: string
...
interface EpisodeSelectorProps {
    ...
    projectName?: string  // localized text，localized text
}
