...
export function SettingsModal({
    ...
    /**
     * localized text，localized text capability fields localized text option write overrides
     * localized text UI localized text（localized text）localized text DB localized text，localized text requireAllFields localized text
     */
    const handleModelChange = (
        ...
        // localized text capabilities localized text fields，localized text
        ...
        const existing = isRecord(nextOverrides[modelKey])
            ? { ...(nextOverrides[modelKey] as Record<string, CapabilityValue>) }
            : {}
        // localized text field localized text（localized text）
        let changed = false
