...
function DefaultParamsRenderer({ fields, overrides, onChange, className }: { fields: CapabilityFieldDefinition[], overrides: Record<string, CapabilityValue>, onChange: (field: string, rawValue: string, sample: CapabilityValue) => void, className?: string }) {
    ...
    return (
        <div className={className}>
            <div className="text-[11px] font-bold text-[#8e8e93] px-1 pt-0.5 mb-2">localized text</div>
            {fields.map(field => {
...
// ============================================================================
// V1: Deep Glass Glow (localized text) 
// localized text V6 localized text。localized text。
// ============================================================================
...
// ============================================================================
// V2: Left Indicator Line (localized text) 
// localized text V7 localized text。
// ============================================================================
...
// ============================================================================
// V3: Fusion (Indicator + Glow) localized text
...
// ============================================================================
// V4: Pill Active Marker + Glow (localized text + localized text)
// localized text，localized text。
// ============================================================================
...
// ============================================================================
// V5: Underline Glow (localized text + localized text)
// localized text Glow localized text，localized text。
// ============================================================================
