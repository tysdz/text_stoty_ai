...
interface PanelCardProps {
  ...
  previousImageUrl?: string | null  // localized text
  ...
  onClearError: () => void
  onUndo?: (panelId: string) => void  // localized text
  onPreviewImage?: (url: string) => void  // localized text
  onInsertAfter?: () => void  // localized text
  onVariant?: () => void  // localized text
  isInsertDisabled?: boolean  // localized text
}
