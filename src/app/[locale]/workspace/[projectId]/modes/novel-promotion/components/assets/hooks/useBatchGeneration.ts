...
/**
 * useBatchGeneration - localized text
 ...
 * 🔥 V6.6 localized text：localized text mutation hooks，remove onGenerateImage prop
 */
...
interface UseBatchGenerationProps {
    projectId: string
    // 🔥 V6.6：remove onGenerateImage，localized text mutation hooks
...
export function useBatchGeneration({
    ...
    // 🔥 V6.6：localized text mutation hooks
