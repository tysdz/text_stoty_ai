...
export function fuzzyMatchLocation(clipLocName: string, libraryLocName: string): boolean {
  ...
  const suffixPattern = /[_\-·](localized text|localized text|daytime|localized text|localized text|localized text|localized text|localized text|localized text|localized text|localized text|localized text|localized text|localized text|localized text|localized text)+$/gi
