...
interface CandidateSelectorProps {
  ...
  candidates: string[]
  selectedIndex: number  // 0 = localized text, 1-n = localized text
  videoRatio: string  // localized text，localized text "16:9", "3:2" localized text
...
export default function CandidateSelector({
  ...
  // localized text（localized text 120px）
