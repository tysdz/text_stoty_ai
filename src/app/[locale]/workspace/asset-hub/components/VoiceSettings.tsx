...
/**
 * localized text - localized text CharacterCard localized text
...
interface VoiceSettingsProps {
    ...
    projectId?: string  // localized text，Asset Hub localized text
    onVoiceChange?: (characterId: string, customVoiceUrl?: string) => void
    onVoiceDesign?: (characterId: string, characterName: string) => void
    onVoiceSelect?: (characterId: string) => void  // localized text
    compact?: boolean  // localized text（localized text）
}
