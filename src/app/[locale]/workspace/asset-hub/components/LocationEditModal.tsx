 ...
 * localized text LocationEditModal localized text
 */
...
export function LocationEditModal({
    ...
    const handleSaveOnly = async () => {
        try {
            ...
            // localized text，localized text summary
