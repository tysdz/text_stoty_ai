...
export function resolveGenerationOptionsForModel(input: {
  ...
  // localized text，localized text「localized text」Location
  ...
  // V7: localized text image localized text resolution localized text，localized text catalog localized text resolutionOptions，
  // localized text，localized text，localized text UI/UX。
  if (input.modelType === 'image') {
    ...
    if (hasResolutionOptions && !hasResolutionInSelection) {
      ...
      // localized text capabilities localized text resolutionOptions，localized text validate localized text
      // 「resolution localized text」localized text，localized text，localized text。
  ...
  // localized text selection localized text，localized text
