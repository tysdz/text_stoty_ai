...
const globalForRedis = globalThis as typeof globalThis & {
  __text_stoty_aiRedis?: RedisSingleton
}
...
const singleton = globalForRedis.__text_stoty_aiRedis || {}
if (!globalForRedis.__text_stoty_aiRedis) {
  globalForRedis.__text_stoty_aiRedis = singleton
}
