...
type GlobalSharedSubscriber = typeof globalThis & {
  __text_stoty_aiSharedSubscriber?: SharedSubscriber
}

const globalForSharedSubscriber = globalThis as GlobalSharedSubscriber

export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__text_stoty_aiSharedSubscriber) {
    globalForSharedSubscriber.__text_stoty_aiSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__text_stoty_aiSharedSubscriber
}
