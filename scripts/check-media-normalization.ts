...
function main() {
  ...
  // localized text 1：localized text extractStorageKey（localized text resolveStorageKeyFromMediaValue）
  ...
  // localized text 2：localized text fetch localized text toFetchableUrl
