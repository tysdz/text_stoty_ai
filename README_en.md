<p align="center">
  <img src="public/banner.png" alt="text_stoty_ai" width="600">
</p>

<h1 align="center">text_stoty_ai AI Video Studio</h1>
...
<p align="center">
  <a href="README.md">Vietnameselocalized text</a> · <a href="https://www.text-stoty-ai.com/">Join Waitlist</a> · <a href="https://github.com/tysdz/text_stoty_ai/issues">Report Bug</a>
</p>
...
- 🌐 **Bilingual UI** — Vietnamese / English, switch in the top-right corner
...
curl -O https://raw.githubusercontent.com/tysdz/text_stoty_ai/main/docker-compose.yml
...
docker rmi ghcr.io/tysdz/text_stoty_ai:latest
curl -O https://raw.githubusercontent.com/tysdz/text_stoty_ai/main/docker-compose.yml
docker compose up -d
```
...
```bash
git clone https://github.com/tysdz/text_stoty_ai.git
cd text_stoty_ai
docker compose up -d
```
...
This project is maintained by tysdzai. You're welcome to contribute by:

- 🐛 Filing [Issues](https://github.com/tysdz/text_stoty_ai/issues) — report bugs
- 💡 Filing [Issues](https://github.com/tysdz/text_stoty_ai/issues) — propose features
...
**Made with ❤️ by tysdzai**

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=tysdz/text_stoty_ai&type=date&legend=top-left)](https://www.star-history.com/#tysdz/text_stoty_ai&type=date&legend=top-left)
